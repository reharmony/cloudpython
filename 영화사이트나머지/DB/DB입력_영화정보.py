...
#         time_list = ["09:00", "10:35", "12:10", "14:35", "16:50", "18:25", "19:50", "21:30", "23:15"]
#         seat_list=[]
#         for x in range(0,5):
#             for y in range(0,5):
#                 seat_list.append("%c%d" % (alpha[x], number[y]))
#         
#         for time in time_list:
#             for seat in seat_list:
#                 sql = "insert into seat values ('" + selectday + "','" + title + "','" + time + "','" + seat + "','0')"
#                 cur.execute(sql)
#         print()
